...
class ApiKeys extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fnpp, fio, glogin, apikey', 'required'),
			array('fnpp', 'numerical', 'integerOnly'=>true),
            array('fio, glogin, apikey', 'length', 'max'=>100),
            array('glogin, apikey', 'unique'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
            array('id, fnpp, fio, glogin, apikey', 'safe', 'on'=>'search'),
		);
	}
    ...
    public function search()
    {
        ...
        $criteria->compare('glogin',$this->glogin,true);
