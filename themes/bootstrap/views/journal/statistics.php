            ...
            <table class=" table table-striped _table-ulist static table-hover"
                ...
                <tr>
                    ...
                    foreach ($data as $dis) {
                        ...
                        if ($dis['kindOfWorkId'] == 2){echo '</br> подгруппа-'.substr($dis['studGroupName'],-1);}
                ...
                if ($steward) {
                    ...
                    foreach ($list as $li) {
                        ...
                        echo '<td colspan="1" style="border-right: 1px solid darkgray; padding:10px;" align="center">' . (($proc[0][$i] != 0)?100*round(($proc[1][$i]/$proc[0][$i]),2):0) . '%</td>';
                        echo '<td colspan="1" style="border-right: 1px solid darkgray; padding:10px;" align="center">' . (($proc[0][$i] != 0)?100*round(($proc[2][$i]/$proc[0][$i]),2):0) . '%</td>';
                        echo '</tr>';
                        $i++;
                    }
                } else {
