...
<nav>
    <ul class="pager">
        ...
        <li class="previous">
            <a href=<?php echo Yii::app()->createUrl('individualplan/load/orgmethLoad')?>>
...
<h1>Организационно-методическая нагрузка преподавателя <br /> <?= $person ? $person->fam . ' ' . $person->nam . ' ' . $person->otc : 'Не определен'?></h1>
