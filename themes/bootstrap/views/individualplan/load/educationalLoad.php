...
<nav>
    <ul class="pager">
        ...
        <li class="previous">
            <a href=<?php echo Yii::app()->createUrl('individualplan/load/educationalLoad')?>>
...
<h1>Учебно-воспитательная нагрузка преподавателя <br /> <?= $person ? $person->fam . ' ' . $person->nam . ' ' . $person->otc : 'Не определен'?></h1>
