...
$this->breadcrumbs = [
    ...
    'Закрепление тем направления №'.CHtml::value($info, 'numDoc')
];
?>

<p class="text-header" style="text-align: center; font-size: 12pt;">
    ПРИЛОЖЕНИЕ К НАПРАВЛЕНИЮ №<strong><ins><?php echo CHtml::value($info, 'numDoc'); ?></ins></strong><br/>
...
<script>
    ...
    function saveTheme() {
        var url = '<?= Yii::app()->createAbsoluteUrl('/studyProcess/extramark/saveKursTheme'); ?>';
