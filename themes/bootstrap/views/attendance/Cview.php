...
?>
<center><h1>Журнал посещаемости группы <?php echo $this->getgroupname($group);?></h1></center>
<?php
...
echo CHtml::endForm();
?>
<?= $this->renderPartial('_tabsviewC', ['dates' => $dates, 'day' => $day, 'activedates' => $activedates]); ?>
<?php
if ($discipline) {
	$numbers = 1;
